...
parser.add_argument('--modeldir', help='Folder the .tflite file is located in',
                    required=True)
parser.add_argument('--width', help='width of video',required=True)
parser.add_argument('--height', help='height of video',required=True)
...
if plyOption.lower() == "live":
    videostream = VideoStream(resolution=(1920,1080),framerate=30)
    print(" video is :", videostream)
else:
